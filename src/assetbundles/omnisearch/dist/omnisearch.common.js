  ...
  methods: {
    ...
    selectFilterMethod: function selectFilterMethod(method) {
      ...
      if (!requiresValue) {
        ...
        this.$nextTick(function () {
          if (_this3.$refs.compareValueTextInput != null) {
            _this3.$refs.compareValueTextInput.focus();
          }
        });
      }
    },
...
/* harmony default export */ var OmniSearchvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    updateFilterCriteria: function updateFilterCriteria() {
      ...
      criteria.filters = _toConsumableArray(this.activeFilters);
...
var OmniSearch_component = normalizeComponent(
  ...
  OmniSearchvue_type_template_id_248f8ed9_render,
  staticRenderFns,
  false,
  null,
  null,
